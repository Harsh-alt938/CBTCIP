...
class MastermindGame:
    def __init__(self, root):
        ...
        self.info_label = tk.Label(self.frame, text="Player 1, set a multi-digit number:", bg="#add8e6", font=("Helvetica", 14))
    ...
    def set_number(self):
        if self.current_player == 1:
            ...
            if self.secret_number.isdigit() and len(self.secret_number) > 0:
    ...
    def guess_number(self):
        ...
        if guess == self.secret_number:
            ...
            if self.current_player == 1:
                ...
                self.info_label.config(text="Player 2, set a multi-digit number:")
    ...
    def reset_game(self):
        self.entry.delete(0, tk.END)
        self.info_label.config(text="Player 1, set a multi-digit number:")
        self.submit_button.config(text="Submit", command=self.set_number)
